...
def _walk_entities(only_city: str | None) -> list[tuple[str, str, str, str, str, str]]:
    ...
    sources = [
        ("vineyards", "vineyards.json"),
        ("tasting-rooms", "tasting-rooms.json"),
        ("wine-bars", "wine-bars.json"),
        ("wine-restaurants", "wine-restaurants.json"),
        ("wine-retailers", "wine-retailers.json"),
        ("wine-schools", "wine-schools.json"),
        ("wine-tours", "wine-tours.json"),
        ("wine-festivals", "wine-festivals.json"),
        ("distilleries", "distilleries.json"),
        ("wine-museums", "wine-museums.json"),
        ("wine-hotels", "wine-hotels.json"),
        ("wine-experiences", "wine-experiences.json"),
        ("budget-wines", "budget-wines.json"),
        ("hidden-gems", "hidden-gems.json"),
        ("day-trips-wine", "day-trips-wine.json"),
    ]
    research_keys = {
        "vineyards": "vineyards",
