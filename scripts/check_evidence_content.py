...
DIETARY_SYNONYMS: dict[str, tuple[str, ...]] = {
    ...
    "lowsulfite":       ("low sulfite", "low-sulfite", "no added sulfites", "no additional sulfites", "no added sulphur", "no added sulfur", "without sulfur", "sulfur addition", "sans soufre", "minimal sulfites", "without sulfites", "low so2"),
}
